...
Special thanks to [Lou Huang](@saikofish). glslEditor born from learned lessons on [TangramPlay](http://tangrams.github.io/tangram-play/). His code and wizdom is all around this project.
